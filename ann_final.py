...
#'plots/ann/optimization/final/{0}/{1}_layer.png'.format(function, dense_layers)
# print("{0}/{1} time: {2}".format(function, dense_layers, time))
#x=X, y=y, batch_size=32, epochs=100, shuffle=True, verbose=0, validation_split=0.3

shuffle = random.sample(range(0, len(ciphers)), len(ciphers))
ciphers_shuffle = ciphers[shuffle]
